...
def process_image(img):
    ...
    # Apply color threshold to identify navigable terrain/obstacles/rock smples
    threshed = color_thresh(warped)
    ...
    obs_x_world, obs_y_world = pix_to_world(obsxpix, obsypix, xpos, ypos,
                                           yaw, world_size, scale)
    #7 updat Rover worldmap (to be displayed on the right side of screen)
    ...
    output_image[0:img.shape[0], img.shape[1]:] = warped[0]
